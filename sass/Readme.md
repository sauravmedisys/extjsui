...
folder are mapped to the application's root namespace, 'extjsui'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'extjsui' in the same way
as `"extjsui/sass/src"`.
